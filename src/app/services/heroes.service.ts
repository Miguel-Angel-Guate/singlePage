...
export class HeroesService {
  private heroes: Heroe[] = [
    ...
    },
    {
      ...
      firstTime: '1974-11-01',
      casa: 'Marvel',
    },
  ];
  constructor() {
    console.log('still working midnight');
  }
  getHeroes(): Heroe[] {
    return this.heroes;
  }
